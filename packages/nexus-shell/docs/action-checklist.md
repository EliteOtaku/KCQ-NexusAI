...
| # | 动作 | 状态 | 备注 |
|---|------|------|------|
| B2-01 | 品种搜索器：下拉+关键字过滤+最近使用 | 未做 | mock 目录 |
| B2-02 | 周期切换：分组下拉 | 未做 | |
| B2-03 | 图例区：品种/周期/OHLC 行 | 未做 | |
| B2-04 | 图例指标行 + 指标眼睛/设置/删除 | 未做 | |
...
| # | 动作 | 状态 | 备注 |
|---|------|------|------|
| B3-01 | Watchlist 右栏：目录列表/点选切品种 | 未做 | |
...
| B4-05 | nexus.* localStorage 持久化（收藏/模板/最近品种/面板/主题） | 未做 | 键名约定见 docs |
