...
export const SHELL_LABELS = {
  ...
  symbolSearchFailed: '搜索失败，请检查当前数据源连接',
  ...
  settingsSourceLabel: '当前数据源',
  settingsSourceManage: '管理数据源',
  settingsSourceMockName: 'Mock（本地生成）',
  sourceManagerTitle: '数据源管理',
  sourceUse: '设为当前',
  sourceUseTitle: '将此数据源设为当前图表数据源',
  sourceCurrent: '当前',
  sourceStatusChecking: '检测中',
  sourceStatusOnline: '在线',
  sourceStatusOffline: '离线',
  sourceEndpointLabel: '地址与端口',
  sourceEndpointHost: '地址',
  sourceEndpointPort: '端口',
  sourceAggregationToggle: '参与聚合搜索',
  sourceSwitchFailed: '切换失败：该数据源不可达，已保持当前源',
