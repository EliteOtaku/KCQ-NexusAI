...
import type { DrawingLabel, DrawingLabels } from '../../../foundation/plugin/index.js'
import { drawingLabelIndexKey, isDrawingLabelIndexKey, normalizeDrawingLabels } from '../drawingLabels'
...
const DISCARD_CASES = [
  ...
  },
  {
    ...
    input: { line: { start: LABEL, '01': LABEL, '-1': LABEL, 0: 'oops', 1: { text: 1 } }, area: {} },
  },
